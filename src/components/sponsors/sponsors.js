    ...
    <>
      ...
      <div className={styles["sponsors-grid"]} style={{flexWrap: "nowrap", margin: "0 8%"}}>
        <div className={`${`${styles["sponsors-img"]} ${styles["sponsor-1"]}`} ${styles["sponsor-1"]}`}>
          <a href="https://replit.com/" rel="external"><Image src={replit} style={{margin: "auto"}} /></a>
        </div>
        <div className={styles["sponsors-flex"]}>
          <div className={`${styles["sponsors-img"]} ${styles["sponsor-2"]}`}>
            <a href="https://gen.xyz/" rel="external"><Image src={xyz} /></a>
          </div>
          <div className={`${styles["sponsors-img"]} ${styles["sponsor-3"]}`}>
          <a href="https://www.scriptindia.org/team" rel="external"><Image src={scriptFoundation} /></a>
          </div>
          <div className={`${styles["sponsors-img"]} ${styles["sponsor-4"]}`}>
          <a href="https://www.hackathonsinternational.com/" rel="external"><Image src={hackathonsIntl} /></a>
          </div>
          <div className={`${styles["sponsors-img"]} ${styles["sponsor-5"]}`}>
          <a href="http://craftbrain.co/" rel="external"><Image src={craftBrain} /></a>
          </div>
          <div className={`${styles["sponsors-img"]} ${styles["sponsor-6"]}`} >
          <a href="https://karoverify.xyz/" rel="external"><Image src={verify} /></a>
          </div>
          <div className={`${styles["sponsors-img"]} ${styles["sponsor-7"]}`}>
          <a href="https://appdevleague.org/" rel="external"><Image src={appDevLeague} /></a>
          </div>
        </div>        
      </div>
    </>
